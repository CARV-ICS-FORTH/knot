...
| `karvdash.uploadsVolumeClaim`       |          | The volume to store temporary file uploads.                                              |                                   |
| `karvdash.uploadsHostPath`          |          | The host path to use for storing uploads, when no existing volume claim is set.          |                                   |
