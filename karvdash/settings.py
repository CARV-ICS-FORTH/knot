...
DASHBOARD_TITLE = os.getenv('KARVDASH_DASHBOARD_TITLE', 'Karvdash')
DOCUMENTATION_URL = os.getenv('KARVDASH_DOCUMENTATION_URL')
...
JUPYTERHUB_URL = os.getenv('KARVDASH_JUPYTERHUB_URL')
JUPYTERHUB_NOTEBOOK_DIR = os.getenv('KARVDASH_JUPYTERHUB_NOTEBOOK_DIR')
